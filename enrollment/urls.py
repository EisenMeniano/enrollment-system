...
urlpatterns = [
    ...
    path("student/downpayment/", views.student_downpayment, name="student_downpayment"),
    path("student/enlistment/", views.student_enlistment_page, name="student_enlistment_page"),
    path("student/my-payment/", views.student_my_payment, name="student_my_payment"),
    path("student/inc-completion/", views.student_inc_completion, name="student_inc_completion"),
